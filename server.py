...
@app.route('/')
def index():
    return render_template("inicio.html",autor1 = {"nombre":"Walter","apellido":"Mendoza"},autor2 = {"nombre":"Byron","apellido":"Lopez"},mensaje=('','',''))
...
def analizar():
    ...
    best = main(params['criterio'],params['criteriop'],f.filename)
    best2 = (best[0],best[1],"Mejor Individuo")
    #(f.filename,params['criterio'],valCriterioFinalizacion,params['criteriop'])
    
    
    print("-----------------")
    #return "OK"
    return render_template("inicio.html",autor1 = {"nombre":"Walter","apellido":"Mendoza"},autor2 = {"nombre":"Byron","apellido":"Lopez"},mensaje=best2)
